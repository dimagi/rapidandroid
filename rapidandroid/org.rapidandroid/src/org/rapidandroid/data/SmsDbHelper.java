...
public class SmsDbHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_PATH= "/sdcard/rapidandroid/rapidandroid.db";
	//private static final String DATABASE_NAME = "rapidandroid.db";
	...
	public SmsDbHelper(Context context) {
		...
		//SQLiteDatabase db = SQLiteDatabase.openDatabase(DATABASE_NAME, null, SQLiteDatabase.CREATE_IF_NECESSARY);
//		onCreate(db);
	...
	public synchronized SQLiteDatabase getWritableDatabase() {
        ...
        SQLiteDatabase db = null;
        //if (mDatabase != null) mDatabase.lock();	//can't call the locks for some reason.  beginTransaction does lock it though
        try {
            mIsInitializing = true;
