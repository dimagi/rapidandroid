 ...
 * 
 * It should be the universal URI accessible content provider that's accessible via the GetContentResolver().query()<br>
 * 
 * The definitions for the URI are linked via the RapidSmsDBConstants static properties.<br><br>
 * 
 ...
 *  <li>insert/query Form/Field/Fieldtype definitions in SQL that reflect the structures defined in the org.rapidsms.java.core.model.*</li>
