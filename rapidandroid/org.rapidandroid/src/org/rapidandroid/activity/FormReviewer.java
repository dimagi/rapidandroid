...
public class FormReviewer extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			...
			// if(formname.equals("")) {
			// //todo: need to figure out how to make this an actual entry
			// section. New dialog on top? or completely switch the activity?
			...
			// android.R.layout.simple_list_item_1, mEmpty));
			// } else {
			// todo: Need to go to DB and pull out all the form info and
			...
			lsv_fields.setAdapter(new ArrayAdapter<String>(this,
					android.R.layout.simple_list_item_1, mFields));
			// }
	...
	private String[] mFields = { "Location (string)", "Hair Color (string)",
			"Age (int)", "Weight (int)", "Height (int)", "blah1", "blah2",
			"blah3", "blah4"
