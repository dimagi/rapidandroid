...
public class Dashboard extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// {
		// public void onItemClick(AdapterView<?> parent, View theparent, int
		// position, long rowid) {
	...
	private void StartFormViewerActivity(String selectedFormName) {
		...
		i.putExtra("FormName", selectedFormName); // bad form, should use some
		// enum here
	...
	private void GetForms() {
		...
		Cursor c = getContentResolver().query(
				RapidSmsDataDefs.Monitor.CONTENT_URI, null, null, null, null);
	...
	private String[] mForms = { "Abbaye de Belloc", "Abbaye du Mont des Cats",
			"Abertam", "Abondance", "Ackawi", "Abbaye de Belloc",
